            ...
            <div class="nk-content-body">
                ...
                <div class="alert alert-pro alert-info">
                    <div class="alert-text">
                        <h6>Informasi</h6>
                        <p>Kata sandi bawaan pengguna adalah <strong>{{ env('DEFAULT_PASSWORD_USER') }}</strong>. Pengguna
                            dapat mengganti kata
                            sandi setelah masuk.
                        </p>
                    </div>
                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" name="pob"
                                                    ...
                                                    placeholder="Masukan tempat lahir" value="{{ old('pob') }}">
                                                @error('pob')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap focused">
                                                ...
                                                <input type="text" name="dob"
                                                    ...
                                                    data-date-format="yyyy-mm-dd" value="{{ old('dob') }}"
